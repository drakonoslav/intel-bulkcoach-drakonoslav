...
# Adjustment priority — least disruptive first (sacred table, cross-verified with meal_plan.py)
_INGREDIENT_PRIORITY = [
    {
        "ingredient": "MCT Powder",  "role": "fat-only",        "unit": "g",
        "primaryMacro": "fat",       "secondaryMacro": None,
        "kcalPerPrimaryUnit": 9.0,   "perIngredientCapG": 25,
    },
    {
        "ingredient": "Dextrin",     "role": "fast carb",        "unit": "g",
        "primaryMacro": "carbs",     "secondaryMacro": None,
        "kcalPerPrimaryUnit": 4.0,   "perIngredientCapG": 50,
        "protectedMealWindows":      ["Post-Lift"],
        "preferredReductionWindow":  "Pre-Lift",
        "distributionNote": "Reduce Pre-Lift pool first. Post-Lift Dextrin is anabolically timed — protect it.",
    },
    {
        "ingredient": "Oats",        "role": "slow carb",        "unit": "g",
        "primaryMacro": "carbs",     "secondaryMacro": "fat",
        "kcalPerPrimaryUnit": 4.0,   "perIngredientCapG": 80,
        "carbsPerG": 0.67, "fatPerG": 0.06, "proteinPerG": 0.17,
    },
    {
        "ingredient": "Bananas",     "role": "carbs + micros",   "unit": "each",
        "primaryMacro": "carbs",     "secondaryMacro": None,
        "kcalPerPrimaryUnit": 4.0,   "perIngredientCapUnits": 2,
        "carbsPerUnit": 27, "proteinPerUnit": 1, "fatPerUnit": 0,
    },
    {
        "ingredient": "Eggs",        "role": "protein + fat",    "unit": "each",
        "primaryMacro": "protein",   "secondaryMacro": "fat",
        "kcalPerPrimaryUnit": 4.0,   "perIngredientCapUnits": 3,
        "proteinPerUnit": 6, "fatPerUnit": 5, "carbsPerUnit": 0,
    },
    {
        "ingredient": "Flaxseed",    "role": "fiber + fat",      "unit": "g",
        "primaryMacro": "fat",       "secondaryMacro": "carbs",
        "kcalPerPrimaryUnit": 9.0,   "perIngredientCapG": 30,
        "fatPerG": 0.40, "carbsPerG": 0.27, "proteinPerG": 0.20,
    },
    {
        "ingredient": "Whey",        "role": "protein anchor",   "unit": "g",
        "primaryMacro": "protein",   "secondaryMacro": None,
        "kcalPerPrimaryUnit": 4.0,   "perIngredientCapG": 40,
        "proteinPerG": 0.80, "carbsPerG": 0.08, "fatPerG": 0.05,
    },
    {
        "ingredient": "Greek Yogurt","role": "protein anchor",   "unit": "cup",
        "primaryMacro": "protein",   "secondaryMacro": None,
        "kcalPerPrimaryUnit": 4.0,   "perIngredientCapUnits": 1,
    },
]
