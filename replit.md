...
app/
  ...
  models.py        — Exercise, Muscle, ActivationMatrixV2, RoleWeightedMatrixV2, PhaseMatrixV3, BottleneckMatrixV4, VolumeLog
  schemas.py       — Pydantic schemas
  seed.py          — CSV/XLSX importer (activation v2 + role-weighted v2 + phase v3 + bottleneck v4)
  routers/
    datasets.py    — GET /datasets
    matrix.py      — GET /matrix/v2, /matrix/role-weighted-v2, /matrix/v3, /matrix/v4/bottleneck
...
## Data Integrity
- Source files: activation CSV (int 0–5), role-weighted CSV (float 0–1), phase XLSX (float 0–5), bottleneck CSV (float 0–1)
